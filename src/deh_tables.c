...
const char *const MOBJTYPE_LIST[] = {  // array length left dynamic for sanity testing later.
	...
	// I was going to surgically remove Ugly Knux to try and unfuck freeslots,
	// but I guess I did the git pull wrong or something and now he's not here in the first place?
	// Sucks that you can't beat FDZ, but at least you can use more than, like, 5 freeslots now.
